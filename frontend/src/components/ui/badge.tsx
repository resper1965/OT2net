  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:focus:ring-zinc-300",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-500 text-zinc-50 hover:bg-green-500/80 dark:bg-green-900 dark:text-zinc-50",
        warning:
          "border-transparent bg-yellow-500 text-zinc-50 hover:bg-yellow-500/80 dark:bg-yellow-900 dark:text-zinc-50",
        info:
          "border-transparent bg-blue-500 text-zinc-50 hover:bg-blue-500/80 dark:bg-blue-900 dark:text-zinc-50",
      },
    },
    defaultVariants: {
      variant: "default",
