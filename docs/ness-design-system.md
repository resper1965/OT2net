# Design System Ness - Guia de Aplicação
...
Arquivo: `frontend/src/styles/ness-tokens.css`

```css
:root {
  --ness-primary: #00ade8;
  --ness-primary-hover-light: #1ab0ff;
  --ness-primary-hover-dark: #33BEE6;
  --ness-primary-pressed: #008bb8;
  /* ... */
}
...
Arquivo: `frontend/tailwind.config.ness.js`
  ...
  theme: {
    extend: {
      colors: {
        'ness-primary': {
          DEFAULT: '#00ade8',
          hover: { light: '#1ab0ff', dark: '#33BEE6' },
          pressed: '#008bb8',
        },
        // ...
      },
...
<span className="font-montserrat font-medium">
  ness<span className="brand-dot">.</span>
</span>

// CTA primário
<button className="ness-cta-primary">
  Ação Principal
</button>

// Badge de marca
<span className="ness-badge">
  n<span className="brand-dot">.</span>secops
</span>
```
...
**Não aplicar quando:**
- Componentes internos de formulários
- Tabelas de dados
- Gráficos e visualizações
- Elementos funcionais que não precisam de destaque
