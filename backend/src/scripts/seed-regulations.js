...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logger.info('Starting Regulations Seed...');
                    regulations = [
                        // === ONS ===
                        {
                            framework: 'ONS',
                    ...
                    logger_1.logger.info("Found ".concat(regulations.length, " regulations to seed."));
                    ...
                    return [4 /*yield*/, rag_service_1.RAGService.processarRegrasEmLote(regulations)];
                case 1:
                    // Process using RAGService to vectorize
                    // We use "as any" because 'FrameworkType' might have specific string literals defined in the service type
                    _a.sent();
                    logger_1.logger.info('Regulations Seed Completed successfully.');
                    return [2 /*return*/];
            }
        });
    });
...
seed()
    .catch(function (e) {
    logger_1.logger.error({ error: e }, 'Error planting seeds');
    process.exit(1);
})
